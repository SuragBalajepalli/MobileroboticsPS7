...
const int HALTING = 3;
const int ALARM_HALTED = 4;
const int ALARM_HALTING = 5;
const int ALARM_REORIENTATION = 6;
...
private:
    ...
    ros::ServiceServer lidar_reset_service_;
    ...
    bool lidarAlarmCallBack(std_srvs::TriggerRequest& request, std_srvs::TriggerResponse& response);
    bool lidarresetCallBack(std_srvs::TriggerRequest& request, std_srvs::TriggerResponse& response);
