...
void DesStatePublisher::initializeServices() {
    ...
    lidar_service_ = nh_.advertiseService("lidar_service",
            &DesStatePublisher::lidarAlarmCallBack, this);
    lidar_reset_service_ = nh_.advertiseService("clear_lidar_service",
            &DesStatePublisher::lidarresetCallBack, this);
...
bool DesStatePublisher::lidarAlarmCallBack(std_srvs::TriggerRequest& request, std_srvs::TriggerResponse& response) {
    ROS_WARN("Lidar!!");
    lidar_trigger_=true;
    return true;
}

bool DesStatePublisher::lidarresetCallBack(std_srvs::TriggerRequest& request, std_srvs::TriggerResponse& response) {
